...
include("conn.php"); 
$id = $_GET['id'];
$sql = "select * from chuku where id = ".$id;
...
出库修改
<form action="updateChukuSubmit.php" method="post" enctype="multipart/form-data">
	...
	<input type="hidden" name="oldDanjia" id="oldDanjia" value ="<?php echo $danjia ?>" />
	<input type="hidden" name="oldJine" id="oldJine" value ="<?php echo $jine ?>" />
	<input type="hidden" name="oldKehumingcheng" id="oldKehumingcheng" value ="<?php echo $kehumingcheng ?>" />
...
重量：<input type="text" name="zhongliang" id="zhongliang" value ="<?php echo $zhongliang ?>" readOnly="true" onchange="setJine()"/> <br/>
单价：<input type="text" name="danjia" id="danjia" value ="<?php echo $danjia ?>" onkeyUp="this.value=this.value.replace(/[^0-9\.]/g,'')" onchange="setJine()"/> <br/>
金额：<input type="text" name="jine" id="jine" value ="<?php echo $jine ?>" readOnly="true"/> <br/>
客户名称：<input type="text" name="kehumingcheng" value ="<?php echo $kehumingcheng ?>" id="kehumingcheng" /> <br/>
