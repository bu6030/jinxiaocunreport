...
&&isset($_POST['zhongliang'])&&isset($_POST['mingcheng'])){
	...
	$sql = "update ruku set riqi = '".$riqi."',jitai='".$jitai."',mingcheng='".$mingcheng."',guige='".$guige."',dengji='".$dengji."',jianshu='".$jianshu."',dingzhong='".$dingzhong."',zhongliang='".$zhongliang."' where id = '".$id."'";

	//$sql = "insert into  ruku (riqi,jitai,mingcheng,guige,dengji,jianshu,dingzhong,zhongliang) values ('".$riqi."','".$jitai."','".$mingcheng."','".$guige."','".$dengji."','".$jianshu."','".$dingzhong."','".$zhongliang."')";
	echo $sql;
    ...
    while ($row=mysql_fetch_array($qres))
    {
		...
		if($cnt>0){
			$updateSql = "update report set rukujianshu = rukujianshu - ".$jianshu.",rukuzhongliang = rukuzhongliang - ".$zhongliang." where jitai = '".$jitai."' and riqi='".$riqi."' and guige = '".$guige."' and mingcheng = '".$mingcheng."' and dengji = '".$dengji."' and dingzhong = ".$dingzhong." ";
    ...
    while ($row=mysql_fetch_array($qres))
    {
		...
		if($cnt>0){
			$updateSql = "update report set rukujianshu = rukujianshu + ".$jianshu.",rukuzhongliang = rukuzhongliang + ".$zhongliang.",dingzhong = ".$dingzhong." where jitai = '".$jitai."' and riqi='".$riqi."' and guige = '".$guige."' and mingcheng = '".$mingcheng."' and dengji = '".$dengji."' and dingzhong = '".$dingzhong."' ";
			echo "==updateSql".$updateSql."==";
			mysql_query($updateSql);
		}else{
			$isnertSql = "insert into report (jitai,riqi,guige,mingcheng,dengji,rukujianshu,dingzhong,rukuzhongliang,chukujianshu,chukuzhongliang) values ('".$jitai."','".$riqi."','".$guige."','".$mingcheng."','".$dengji."','".$jianshu."','".$dingzhong."','".$zhongliang."',0,0)";
